...
if (isset($_SERVER['HTTP_AUTHORIZATION'])) {
    ...
    if (array_key_exists("start", $_GET)) {
        ...
        $returnData["per_page"] = $user_system->user_system_total;
        $returnData["page"] = (int)$user_system->user_system_start;
        $returnData["total_pages"] = ceil($total_result->rowCount() / $user_system->user_system_total);
