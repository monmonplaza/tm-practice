...
class UserSystem
{
    ...
    {
        $this->connection = $db;
        $this->tblUserSystem = "vr_user_system";
        $this->tblRole = "vr_roles";
        // $this->tblAccess = "tmv1_access";
    }
    ...
    public function create()
    {
        try {
            ...
            $query->execute([
                ...
                "user_system_code" => $this->user_system_code,
    ...
    public function readAll()
    {
        try {
            ...
            $sql .= "user.user_system_code, ";
            $sql .= "user.user_system_key, ";
            $sql .= "role.*, ";
    ...
    public function readLogin()
    {
        try {
            ...
            $sql .= "from {$this->tblUserSystem} as user, ";
            $sql .= "{$this->tblRole} as role ";
            // $sql .= "{$this->tblAccess} as access ";
            $sql .= "where user.user_system_role_id = role.role_aid ";
            // $sql .= "and access.access_role_id = role.role_aid ";
    ...
    public function updateUserOTPcode() {
        try {
            $sql = "update {$this->tblUserSystem} set ";
            $sql .= "user_system_code = :user_system_code, ";
            $sql .= "user_system_datetime = :user_system_datetime ";
