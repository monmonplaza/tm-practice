...
const ModalConfirm = ({ setIsArchive, item }) => {
  const handleCloseRole = () => setIsArchive(false);
      ...
      border-gray-400 rounded-md py-8 px-5 max-w-[420px] w-full "
        >
          <div className="modal__header relative">
            <BiSolidArchiveIn className="fill-primary text-2xl mb-2" />
            <button
          ...
          <div className="modal__body">
            ...
            <p>
              {`You are about to archive ${item.name}, do you want to continue?`}
            </p>
          </div>
