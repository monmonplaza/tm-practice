...
const ModalAddClient = ({ itemEdit }) => {
  ...
  const mutation = useMutation({
    mutationFn: (values) =>
      queryData(
        itemEdit
          ? `/v1/controllers/developer/client/client.php?clientId=${itemEdit.client_aid}` //update
          : "/v1/controllers/developer/client/client.php", //add
        itemEdit ? "put" : "post",
        values
      ),
    onSuccess: (data) => {
  ...
  const initVal = {
    ...
    client_id: itemEdit ? itemEdit.client_id : "",
    client_first_name: itemEdit ? itemEdit.client_first_name : "",
    client_last_name: itemEdit ? itemEdit.client_last_name : "",
