...
const ClientTable = ({ setItemEdit }) => {
  ...
  const {
    ...
    "/v1/controllers/developer/client/client.php", // endpoint
    "get", // method
    "client" // key
  );
  ...
  return (
    <>
      ...
      {store.isConfirm && (
        <ModalConfirm
          mysqlApiArchive={`/v1/controllers/developer/client/active.php?clientId=${id}`}
          msg={"Are you sure you want to archive this client?"}
          item={dataItem.client_first_name}
          queryKey={"client"}
        />
      )}
      ...
      {store.isRestore && (
        <ModalDeleteAndRestore
          id={id}
          isDel={isDel}
          mysqlApiDelete={`/v1/controllers/developer/client/client.php?clientId=${id}`}
          mysqlApiRestore={`/v1/controllers/developer/client/active.php?clientId=${id}`}
          msg={
            isDel
